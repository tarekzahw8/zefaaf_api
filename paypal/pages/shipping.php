            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input class="form-control"
                           ...
                           id="line1"
                           name="line1"
                           value="2211 North Street"
                           >
                </div>
            </div>
            <div class="form-group">
                <label for="line2" class="col-sm-5 control-label">Address Line 2</label>
                <div class="col-sm-7">
                    <input class="form-control"
                           type="text"
                           id="line2"
...
<!-- Javascript Import -->
<script src="https://www.paypal.com/sdk/js?intent=capture&vault=false&client-id=sb<?php echo isset($_GET['buyer-country']) ? "&buyer-country=" . $_GET['buyer-country'] : "" ?>"></script>
