...
$app->group('/v1', function (Group $group)  {
    $group->group('/mobile', function(Group $group) {
        ...
        $group->get('/availabilityToEditProfile', 'App\Controller\Mobile:availabilityToEditProfile');
        $group->post('/updateUserDetails', 'App\Controller\Mobile:updateUserDetails');
        ...
        $group->get('/getMessagesList', 'App\Controller\Mobile:getMessagesList');
                ...
                $group->get('/getMessagesList2/[{reasonId}]', 'App\Controller\Mobile:getMessagesList2');
                
        $group->get('/getMessageDetails/{id}', 'App\Controller\Mobile:getMessageDetails');
        
                $group->get('/getMarriageRequestsList', 'App\Controller\Mobile:getMarriageRequestsList');
        ...
        $group->post('/openChatV1', 'App\Controller\Mobile:openChatV1');
        ...
        //marriage routes
        $group->get('/getMarriageDetails', 'App\Controller\Mobile:getMarriageDetails');
        $group->post('/marriageRequest', 'App\Controller\Mobile:marriageRequest');
        $group->post('/updateMarriageRequest/{messageId}', 'App\Controller\Mobile:updateMarriageRequest');
        $group->post('/deleteMarriageRequest/{messageId}','App\Controller\Mobile:deleteMarriageRequest');

        //tape news

        $group->get('/getNewsTapeData', 'App\Controller\Mobile:getNewsTapeData');

        $group->get('/getMobileRequests/{page}', 'App\Controller\Mobile:getMobileRequests');
    ...
    $group->group('/crud', function(Group $group) {
            ...
            //news tape route update 
            $group->post('/update/news','App\Controller\Crud:updateNewsTape');
            
            //----
            $group->get('/getHome','App\Controller\Crud:getHome');
         
            $group->get('/listMessages/{page}','App\Controller\Crud:listMessages');
            $group->get('/listMessages2/{page}/{reasonId}/[{search}]','App\Controller\Crud:listMessages');
            
            $group->get('/listMarriageRequests/{page}/[{search}]','App\Controller\Crud:listMarriageRequests');
            ...
            $group->post('/testAdminNotification','App\Controller\Crud:testAdminNotification');
