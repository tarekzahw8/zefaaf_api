...
$factory = (new Factory)
    ->withServiceAccount('zefaaf-16c8a-2ba0f53606d6.json');
...
// Prepare the notification and data
...
//                 $token = 'fFsXpGmhRmWi4zaZCT9csL:APA91bG06Es6S4JD22TWVj5TKsmCyeS6wFJ6e9x1hdKf3BWIjL_gR2Bo__7A55a_p_FnxyPIa5qLmfMuziWw2BN5TLRq-IcMfqX_DtIa4Ze8eD7748F0VZG-8pblizt4YqLWfNcuGsGE'; // Replace with your device token
...
//             ];
//             $messageData = CloudMessage::withTarget('token', $token)
//                 ->withNotification($notification)
//                 ->withData($data);
...
// // Device token for sending the notification
// $token = 'fFsXpGmhRmWi4zaZCT9csL:APA91bG06Es6S4JD22TWVj5TKsmCyeS6wFJ6e9x1hdKf3BWIjL_gR2Bo__7A55a_p_FnxyPIa5qLmfMuziWw2BN5TLRq-IcMfqX_DtIa4Ze8eD7748F0VZG-8pblizt4YqLWfNcuGsGE'; // Replace with your device token
...
//     echo 'Notification sent successfully. Result: ' . $result;
// } catch (Exception $e) {
